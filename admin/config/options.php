...
return array(
	...
	'widget'	=> array(
		...
		'settings_fields'	=> array(
			...
			array(
				'id'		=> 'widget_taxonomies_posts',
				'title'		=> __( 'Taxonomies Posts Widget', 'italystrap' ),
				'callback'	=> 'get_field_type',
				'page'		=> 'italystrap_options_group',
				'section'	=> 'widget',
				'args'		=> array(
						'name'			=> __( 'Lists of Posts by Taxonomies (cats, tags and custom tax)', 'italystrap' ),
						...
						'id'			=> 'widget_taxonomies_posts',
						'type'			=> 'checkbox',
						'class'			=> 'widget_taxonomies_posts hard',
						'default'		=> '',
						// 'validate'	=> 'ctype_alpha',
						'sanitize'		=> 'sanitize_text_field',
				),
