...
return array(
		...
		'settings_fields'	=> array(
			...
			array(
				...
				'args'		=> array(
						...
						'desc'			=> __( 'This is only for get a visual of the Theme Hooks.', 'italystrap' ),
						'id'			=> 'show_theme_hooks',
						'type'			=> 'checkbox',
				...
				'show_on'				=> 'italystrap' === wp_get_theme()->template,
			),
			array(
		...
		'settings_fields'	=> array(
			...
			array(
				...
				'args'		=> array(
						...
						'desc'			=> __( 'Add an advanced custom menu to your sidebar.', 'italystrap' ),
						'id'			=> 'widget_nav_menu',
						'type'			=> 'checkbox',
			...
			array(
				...
				'show_on'				=> \ItalyStrap\Core\is_debug(),
			),
			// array(
			// 	'id'		=> 'vcardwidget',
	...
	'media'	=> array(
		...
		'settings_fields'	=> array(
			...
			array(
				'id'		=> 'lazyload_video',
				'title'		=> __( 'Lazy Loading of embedded video', 'italystrap' ),
				'callback'	=> 'get_field_type',
				'page'		=> 'italystrap_options_group',
				'section'	=> 'media',
				'args'		=> array(
