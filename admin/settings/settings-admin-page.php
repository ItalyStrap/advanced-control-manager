		...
		'settings_fields'	=> array(
			...
			array(
				...
				'args'		=> array(
						...
						'desc'			=> __( 'Activate product widget and displays list of product with an array of options, this widget will work only if you have WooCommerce installed and activated.', 'italystrap' ),
						'id'			=> 'widget_product',
						'type'			=> 'checkbox',
