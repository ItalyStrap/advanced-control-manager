<?php namespace ItalyStrap\classes;
use WP_Widget, WP_Query;
/**
 * This class is forked from Ultimate Posts Widget by Boston Dell-Vandenberg http://pomelodesign.com and modify by me with a lot of functionality and schema.org markup
 * Original plugin here http://wordpress.org/plugins/ultimate-posts-widget/
 */
if ( !class_exists( 'ItalyStrap_Posts_Widget' ) ) {

	class ItalyStrap_Posts_Widget extends WP_Widget {
		...
		function __construct() {
			...
			load_plugin_textdomain('ItalyStrap', false, basename( dirname( __FILE__ ) ) . '/languages' );
      ...
      // Excerpt length filter
			...
			if ($instance['template'] === 'custom') {
				$custom_template_path = apply_filters('italystrap_custom_template_path',  '/upw/' . $instance['template_custom'] . '.php', $instance, $this->id_base);
      ...
      // Reset the global $the_post as this query will have stomped on it
		 ...
		 * @return void Enqueue script and style
		 */
...
<div class="upw-tabs">
	<a class="upw-tab-item active" data-toggle="upw-tab-general"><?php _e('General', 'ItalyStrap'); ?></a>
	<a class="upw-tab-item" data-toggle="upw-tab-display"><?php _e('Display', 'ItalyStrap'); ?></a>
	<a class="upw-tab-item" data-toggle="upw-tab-filter"><?php _e('Filter', 'ItalyStrap'); ?></a>
	<a class="upw-tab-item" data-toggle="upw-tab-order"><?php _e('Order', 'ItalyStrap'); ?></a>
</div>

<div class="upw-tab upw-tab-general">

	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'ItalyStrap' ); ?>:</label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" />
	</p>

	<p>
		<label for="<?php echo $this->get_field_id( 'title_link' ); ?>"><?php _e( 'Title URL', 'ItalyStrap' ); ?>:</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'class' ); ?>"><?php _e( 'CSS class', 'ItalyStrap' ); ?>:</label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'class' ); ?>" name="<?php echo $this->get_field_name( 'class' ); ?>" type="text" value="<?php echo $class; ?>" />
	</p>

	<p>
		<label for="<?php echo $this->get_field_id('before_posts'); ?>"><?php _e('Before posts', 'ItalyStrap'); ?>:</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('after_posts'); ?>"><?php _e('After posts', 'ItalyStrap'); ?>:</label>
...
<div class="upw-tab upw-hide upw-tab-display">
	...
	<p>
		<label for="<?php echo $this->get_field_id('template'); ?>"><?php _e('Template', 'ItalyStrap'); ?>:</label>
		<select name="<?php echo $this->get_field_name('template'); ?>" id="<?php echo $this->get_field_id('template'); ?>" class="widefat">
			<option value="legacy"<?php if( $template == 'legacy') echo ' selected'; ?>><?php _e('Legacy', 'ItalyStrap'); ?></option>
			<option value="standard"<?php if( $template == 'standard') echo ' selected'; ?>><?php _e('Standard', 'ItalyStrap'); ?></option>
			<option value="custom"<?php if( $template == 'custom') echo ' selected'; ?>><?php _e('Custom', 'ItalyStrap'); ?></option>
		</select>
	</p>

	<p<?php if ($template !== 'custom') echo ' style="display:none;"'; ?>>
	<label for="<?php echo $this->get_field_id('template_custom'); ?>"><?php _e('Custom Template Name', 'ItalyStrap'); ?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of posts', 'ItalyStrap' ); ?>:</label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show title', 'ItalyStrap' ); ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Show published date', 'ItalyStrap' ); ?></label>
</p>

<p<?php if (!$show_date) echo ' style="display:none;"'; ?>>
<label for="<?php echo $this->get_field_id('date_format'); ?>"><?php _e( 'Date format', 'ItalyStrap' ); ?>:</label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_author' ); ?>"><?php _e( 'Show post author', 'ItalyStrap' ); ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_comments' ); ?>"><?php _e( 'Show comments count', 'ItalyStrap' ); ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>"><?php _e( 'Show excerpt', 'ItalyStrap' ); ?></label>
</p>

<p<?php if (!$show_excerpt) echo ' style="display:none;"'; ?>>
<label for="<?php echo $this->get_field_id('excerpt_length'); ?>"><?php _e( 'Excerpt length (in words)', 'ItalyStrap' ); ?>:</label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_content' ); ?>"><?php _e( 'Show content', 'ItalyStrap' ); ?></label>
</p>
...
<label for="<?php echo $this->get_field_id('show_readmore'); ?>">
	...
	<?php _e( 'Show read more link', 'ItalyStrap' ); ?>
</label>
</p>
...
<?php if ( function_exists('the_post_thumbnail') && current_theme_supports( 'post-thumbnails' ) ) : ?>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id( 'show_thumbnail' ); ?>"><?php _e( 'Show thumbnail', 'ItalyStrap' ); ?></label>
	</p>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('show_cats'); ?>"> <?php _e('Show post categories', 'ItalyStrap'); ?></label>
</p>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('show_tags'); ?>"> <?php _e('Show post tags', 'ItalyStrap'); ?></label>
</p>

<p>
	<label for="<?php echo $this->get_field_id( 'custom_fields' ); ?>"><?php _e( 'Show custom fields (comma separated)', 'ItalyStrap' ); ?>:</label>
...
<div class="upw-tab upw-hide upw-tab-filter">
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('atcat'); ?>"> <?php _e('Show posts only from current category', 'ItalyStrap');?></label>
	</p>

	<p>
		<label for="<?php echo $this->get_field_id('cats'); ?>"><?php _e( 'Categories', 'ItalyStrap' ); ?>:</label>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('attag'); ?>"> <?php _e('Show posts only from current tag', 'ItalyStrap');?></label>
	</p>

	<p>
		<label for="<?php echo $this->get_field_id('tags'); ?>"><?php _e( 'Tags', 'ItalyStrap' ); ?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id('types'); ?>"><?php _e( 'Post types', 'ItalyStrap' ); ?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id('sticky'); ?>"><?php _e( 'Sticky posts', 'ItalyStrap' ); ?>:</label>
	<select name="<?php echo $this->get_field_name('sticky'); ?>" id="<?php echo $this->get_field_id('sticky'); ?>" class="widefat">
		<option value="show"<?php if( $sticky === 'show') echo ' selected'; ?>><?php _e('Show All Posts', 'ItalyStrap'); ?></option>
		<option value="hide"<?php if( $sticky == 'hide') echo ' selected'; ?>><?php _e('Hide Sticky Posts', 'ItalyStrap'); ?></option>
		<option value="only"<?php if( $sticky == 'only') echo ' selected'; ?>><?php _e('Show Only Sticky Posts', 'ItalyStrap'); ?></option>
	</select>
</p>
...
<div class="upw-tab upw-hide upw-tab-order">
	...
	<p>
		<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e('Order by', 'ItalyStrap'); ?>:</label>
		<select name="<?php echo $this->get_field_name('orderby'); ?>" id="<?php echo $this->get_field_id('orderby'); ?>" class="widefat">
			<option value="date"<?php if( $orderby == 'date') echo ' selected'; ?>><?php _e('Published Date', 'ItalyStrap'); ?></option>
			<option value="title"<?php if( $orderby == 'title') echo ' selected'; ?>><?php _e('Title', 'ItalyStrap'); ?></option>
			<option value="comment_count"<?php if( $orderby == 'comment_count') echo ' selected'; ?>><?php _e('Comment Count', 'ItalyStrap'); ?></option>
			<option value="rand"<?php if( $orderby == 'rand') echo ' selected'; ?>><?php _e('Random'); ?></option>
			<option value="meta_value"<?php if( $orderby == 'meta_value') echo ' selected'; ?>><?php _e('Custom Field', 'ItalyStrap'); ?></option>
			<option value="menu_order"<?php if( $orderby == 'menu_order') echo ' selected'; ?>><?php _e('Menu Order', 'ItalyStrap'); ?></option>
		</select>
	</p>

	<p<?php if ($orderby !== 'meta_value') echo ' style="display:none;"'; ?>>
	<label for="<?php echo $this->get_field_id( 'meta_key' ); ?>"><?php _e('Custom field', 'ItalyStrap'); ?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id('order'); ?>"><?php _e('Order', 'ItalyStrap'); ?>:</label>
	<select name="<?php echo $this->get_field_name('order'); ?>" id="<?php echo $this->get_field_id('order'); ?>" class="widefat">
		<option value="DESC"<?php if( $order == 'DESC') echo ' selected'; ?>><?php _e('Descending', 'ItalyStrap'); ?></option>
		<option value="ASC"<?php if( $order == 'ASC') echo ' selected'; ?>><?php _e('Ascending', 'ItalyStrap'); ?></option>
	</select>
</p>
...
<?php
	...
	function init_wp_italystrap_posts_widget(){

		register_widget( 'ItalyStrap\classes\ItalyStrap_Posts_Widget' );

	}

	add_action( 'widgets_init', 'ItalyStrap\classes\init_wp_italystrap_posts_widget' );
