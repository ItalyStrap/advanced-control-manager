	...
	class Widget_VCard extends Widget {
		...
		function __construct() {
			...
			$args = array(
				...
				'description'		=> __( 'Add a vCard Local Business with Schema.org markup to widgetized area', 'ItalyStrap' ),
				'fields'			=> $fields,
		...
		public function widget_render( $args, $instance ) {
			...
			require( ITALYSTRAP_PLUGIN_PATH . 'widget/templates/content-vcard.php' );
